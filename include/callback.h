...
{
public:
    virtual void KeyboardCB(CALLBACK_KEY OgldevKey, CALLBACK_KEY_STATE OgldevKeyState = OGLDEV_KEY_STATE_PRESS) {};
    
    virtual void PassiveMouseCB(int x, int y) {};

    virtual void RenderSceneCB() {};

    virtual void MouseCB(CALLBACK_MOUSE Button, CALLBACK_KEY_STATE State, int x, int y) {};
};
