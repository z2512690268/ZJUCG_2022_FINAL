...
bool ModelEditor::show_main_window;
bool ModelEditor::show_generate_model_window;
bool ModelEditor::show_model_joint_window;
bool ModelEditor::show_model_angle_window;

glm::vec4 ModelEditor::clearColor;
